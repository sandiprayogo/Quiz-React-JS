...
function App() {
   ...
   return !userName ? (
      <div className="startScreen">
         <header>
            <h1>
               selamat datang di<span className="big">QUIZ senang</span>
               <br />
               quiz untuk bergembira
            </h1>
         </header>
      ...
      <div className="app vh-100">
         <>
            ...
            <div className="main col-9">
               {gameOver ? (
                  <h1>
                     Game over! <br /> <span className="big">{userName}</span>{" "}
                     earn: ★ {earn} in total !
                  </h1>
               ) : timeOut ? (
